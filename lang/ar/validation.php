...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'whatsapp'              => 'واتساب',
        'logo'                  => 'شعار العيادة',
        'vendor.phone'          => 'جوال العيادة',
        'vendor.name'           => 'اسم العيادة',
        'vendor.address'        => 'عنوان العيادة',
        'vendor.logo'           => 'شعار العيادة',
        'period'                => 'فترة',
        'required_price'        => 'السعر المطلوب',
        'selling_reason'        => 'سبب البيع',
        "salaries"              => 'قيمة الرواتب',
        "rent"                  => 'قيمة الايجار',
        "employees"             => 'عدد الموظفين',
        "area"                  => 'المساحة',
        "income"                => 'المدخول السنوي',
        "earnings"              => 'الارباح السنوية',
        "visas"                 => 'عدد الفيز',
        'paying_type'           => 'شروط الدفع',
        'date_of_birth'         => 'تاريخ الميلاد',
        'tickets'               => 'تذاكر',
        'dependency_tickets'    => 'تذاكر الاطفال',
        'dependency'            => 'الاطفال',
        'ticket'                => 'تذكرة',
        'roles'                 => 'الادوار',
        'role'                  => 'دور',
        ...
        'profile'               => 'الحساب',
        'instagram_account'     => 'حساب انستاجرام',
