<template>
    <AuthenticatedLayout>
        <h2 class="intro-y text-lg font-medium mt-10">
            {{ props.event.title }} > {{ t("validation.attributes.media") }}
        </h2>
...
deleteRouteKey.value = "medium";
routingParam.event = props.event.uuid;
deleteLink.value = "dashboard.media.destroy";
