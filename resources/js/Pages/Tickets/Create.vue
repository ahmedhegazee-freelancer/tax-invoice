                ...
                <div class="intro-y box p-5">
                    <div>
                        ...
                        <TomSelect
                            ...
                            v-model="form.race"
                            class="w-full"
                            :options="availableRacesSelectOptions"
                        >
                            <option value="0"></option>
                        </TomSelect>
...
import { availableSelectOptions } from "@/Composables/EventsSearchSelectBox";
import {
    availableRacesSelectOptions,
    eventId,
...
const submitForm = async () => {
    ...
    if (!result) return;
    form.post(route("dashboard.ticket.store"), {
        onSuccess: () => {
