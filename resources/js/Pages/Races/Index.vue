        ...
        <div class="grid grid-cols-12 gap-6 mt-5">
            ...
            >
                <Link
                    ...
                    :href="route('dashboard.race.create')"
                >
                    {{ t("admin.add") + " " + t("validation.attributes.race") }}
                </Link>
            </div>
            <div
                class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2"
            ...
            <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
                <table class="table table-report -mt-2">
                    ...
                    <tbody>
                        <tr
                            v-for="(race, fakerKey) in props.races.data"
                            :key="fakerKey"
                            class="intro-x"
                        >
                            <td>
                            ...
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    ...
                                    <a
                                        ...
                                        href="javascript:;"
                                        @click="openDeleteModal(race.uuid)"
                                    >
                                    ...
                                    <a
                                        class="flex items-center text-danger"
                                        href="javascript:;"
                                        v-if="race.is_finished == 0"
                                        @click="
                                            openChangeStatusModal(race.uuid)
                                        "
                                    >
            ...
            >
                <pagination :links="props.races.links" />
            </div>
            <!-- END: Pagination -->
        </div>
...
deleteRouteKey.value = "race";
deleteLink.value = "dashboard.race.destroy";
refreshRecords.value = "races";
changeStatusRoute.value = {
    route: "dashboard.race.close",
    paramsKey: "race",
    dataName: "races",
};
</script>
