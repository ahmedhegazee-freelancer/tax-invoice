    ...
    <AuthenticatedLayout>
        <div class="intro-y flex items-center mt-8">
            <h2 class="text-lg font-medium mr-auto">
                {{ t("admin.update") + " " + t("admin.race_details") }}
            </h2>
        </div>
...
const fillTranslation = () => {
    for (const key in { content: "", title: "" }) {
        form.ar[key] = props.detail.translations.ar[key];
        form.en[key] = props.detail.translations.en[key];
    }
};
</script>
<style></style>
